...
Behind these numbers is an entire ecosystem of organizations competing at every tier. The chart categorizes players from frontier models down to honorable mentions—but it's already outdated. Since this visualization was created in early October, [MiniMax released M2](https://huggingface.co/MiniMaxAI/MiniMax-M2), which now claims the top spot in Artificial Analysis intelligence rankings. The pace of releases is so rapid that static snapshots become obsolete within weeks.
