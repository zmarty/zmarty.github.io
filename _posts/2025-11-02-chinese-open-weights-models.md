...
**The Fall of Llama's Halo.** Llama set the pace for open-weights in 2023-24, but its momentum visibly eroded in 2025 as developers gravitated toward Chinese families with better price-performance and looser licenses. Trust took a hit in May when [Meta was accused of "gaming" benchmarks](https://www.theverge.com/meta/645012/meta-llama-4-maverick-benchmarks-gaming?utm_source=chatgpt.com) by showcasing a tuned Llama 4 variant that differed from the public release - Meta denied wrongdoing, but the episode hardened skepticism around leaderboards. At the same time, the [Open Source Initiative reiterated that Llama's community license isn't truly open source](https://opensource.org/blog/metas-llama-license-is-still-not-open-source?utm_source=chatgpt.com) (notably its 700M-MAU clause), nudging teams toward Apache-2.0 options like many Qwen releases. [Independent tracking through mid-2025](https://artificialanalysis.ai/downloads/china-report/2025/Artificial-Analysis-State-of-AI-China-Q1-2025.pdf?utm_source=chatgpt.com) shows Chinese labs accelerating on both capability and adoption - Qwen's surge, alongside DeepSeek and others, steadily displaced Llama from the default "base model" slot in many stacks.
