...
| Name                                                                       | GitHub stars | License                                                                               | Scale                                     |
| -------------------------------------------------------------------------- | ------------- | ---------------------------------------------------------------------------------- | ----------------------------------------- |
| [vLLM](https://docs.vllm.ai/)                                              | 63.1k         | Apache-2.0                                                           | High-throughput production                |
| [SGLang](https://docs.sglang.ai/)                                          | 20.2k         | Apache-2.0                                                           | High-throughput production                |
| [TensorRT-LLM](https://nvidia.github.io/TensorRT-LLM/)                     | 12.1k         | Apache-2.0                                                        | High-throughput production                |
| [llama.cpp](https://github.com/ggml-org/llama.cpp)                         | 89.8k         | MIT                                                                  | Enthusiast / local-first                  |
| [exllamav3](https://github.com/turboderp-org/exllamav3)                    | 571           | MIT                                                                  | Enthusiast / local-first                  |
| [MLX (Apple MLX + MLX-LM)](https://github.com/ml-explore/mlx-lm)              | 22.8k         | MIT                                                                  | Enthusiast / Apple-silicon dev & research |
| [Ollama](https://ollama.com/)                                              | 156k          | MIT                                                                  | Enthusiast / local-first                  |
